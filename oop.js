...
const finalArray = [random1, random2, random3, random4, random5];
async function myHotel(finalArray) {
    ...
    const match = finalArray.find(element => element.fullName === givenName &&
